  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="vault-panel p-4 mb-4 text-center">
        ...
        <p className="text-base text-dark-600 dark:text-dark-300 mb-1 font-medium">
        ...
        <div className="vault-panel p-4 mb-4">
          <h2 className="text-base font-display font-bold text-dark-700 dark:text-dark-200 mb-2 flex items-center gap-4.5">
            <svg className="w-5 h-5 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            What is Quai Vault?
          </h2>
          <p className="text-base text-dark-500 dark:text-dark-400 mb-3 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="vault-panel p-4">
            <div className="flex items-start gap-4 mb-2">
              <div className="flex-shrink-0 w-6 h-6 rounded bg-primary-100 dark:bg-primary-900/30 border border-primary-300 dark:border-primary-700/50 flex items-center justify-center">
                <svg className="w-5 h-5 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <div>
                <h3 className="text-base font-display font-bold text-dark-700 dark:text-dark-200 mb-0.5">Enhanced Security</h3>
          ...
          <div className="vault-panel p-4">
            <div className="flex items-start gap-4 mb-2">
              ...
              <div>
                <h3 className="text-base font-display font-bold text-dark-700 dark:text-dark-200 mb-0.5">Collaborative Control</h3>
                <p className="text-base text-dark-500 leading-relaxed">
          ...
          <div className="vault-panel p-4">
            <div className="flex items-start gap-4 mb-2">
              ...
              <div>
                <h3 className="text-base font-display font-bold text-dark-700 dark:text-dark-200 mb-0.5">Decentralized & Trustless</h3>
                <p className="text-base text-dark-500 leading-relaxed">
          ...
          <div className="vault-panel p-4">
            <div className="flex items-start gap-4 mb-2">
              ...
              <div>
                <h3 className="text-base font-display font-bold text-dark-700 dark:text-dark-200 mb-0.5">Flexible Configuration</h3>
                <p className="text-base text-dark-500 leading-relaxed">
        ...
        <div className="vault-panel p-4">
          ...
          <div className="space-y-2">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-5 h-5 rounded-full bg-primary-100 dark:bg-primary-900/50 border border-primary-300 dark:border-primary-700/50 flex items-center justify-center text-base font-bold text-primary-600 dark:text-primary-300">
                1
              </div>
              <div>
                <p className="text-base text-dark-600 dark:text-dark-300 font-medium mb-0.5">Create Your Vault</p>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-base text-dark-600 dark:text-dark-300 font-medium mb-0.5">Propose Transactions</p>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-base text-dark-600 dark:text-dark-300 font-medium mb-0.5">Gather Approvals</p>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-base text-dark-600 dark:text-dark-300 font-medium mb-0.5">Execute & Track</p>
